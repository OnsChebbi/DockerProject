 ...
 * @Configuration
 * 
 * @EnableSwagger2 public class SpringFoxSwaggerConfig {
 * 
 ...
 * 
 * private ApiInfo apiEndPointsInfo() { return new ApiInfoBuilder()
 * .title("My STOCK PROJECT") .description("Micro-Service Documentation")
 * .version("1.0.0") .build(); }
 * 
 * private ApiKey apiKey() { return new ApiKey("Bearer", AUTHORIZATION_HEADER,
 * "header"); }
 * 
 * 
